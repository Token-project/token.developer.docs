...
Here is an example of what a request looks like. You must replace $BEARER\_TOKEN with the Bearer Token that you generate in your App, and have the proper access for this request to work:
...
To help manage the volume of API requests, API calls using are rate limited per endpoint at the App-level. These limits help us provide a reliable and scalable API to rely on.
